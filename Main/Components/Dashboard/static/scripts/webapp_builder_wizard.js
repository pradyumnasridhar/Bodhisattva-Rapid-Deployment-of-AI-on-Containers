...
function createWebapp(event) {
	...
	WebappNameDiv = document.getElementById("webapp-name");
	if (WebappNameDiv.value == "") {
		alert("Please provide a name for your web app");
		return;
	}

	descriptionDiv = document.getElementById("description");
	if (descriptionDiv.value == "") {
		alert("Please provide a description for your web app");
		return;
	}

	webappRepoURLDiv = document.getElementById("git-repo-url");
	if (webappRepoURLDiv.value == "") {
		alert("Please specify the remote URL of your web app source repository");
		return;
	}
	...
	loading = document.getElementById("create-webapp-loading");
...
function deployWebroles(event) {
	...
	loading = document.getElementById("deploy-webroles-loading");
	loading.style.display = "inline";
...
function deployWorkerroles(event) {
	...
	loading = document.getElementById("deploy-workerroles-loading");
	loading.style.display = "inline";
