...
console.log(baseModelId);
baseModelId = parseInt(baseModelId);
if (baseModelId == 0) {
	baseModelId = 1;
}
baseModelName = baseModelNames[baseModelId - 1];
function updateSelectedBaseModel() {
	console.log("updateSelectedBaseModel");
	document.getElementById("base-model").selectedIndex = baseModelId - 1;	
	console.log(document.getElementById("base-model").options);
	// document.getElementById("base-model").options[baseModelId - 1].selected = true;
}
modelName = "";
modelDescription = "";
...
function makeProgress() {
	...
	if (myProgressBar.getAttribute("data-transitiongoal") == 100) {
		...
		myProgressBarTimeout = setTimeout(makeProgress, 100);
	}
}
...
function prepareModel() {
	...
	loading = document.getElementById("prepmodel-loading");
...
function trainModel() {
	...
	loading = document.getElementById("trainmodel-loading");
	loading.style.display = "inline";
